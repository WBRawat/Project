...
// Handle Add to Cart
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['accessory_id'])) {
...
<body>
    ...
    <main>
        <h2 class="animate-welcome" style="color: #D4A017; font-family: 'Playfair Display', serif; font-size: 2rem; text-align: center; margin-bottom: 30px; text-shadow: 0 0 8px rgba(212, 160, 23, 0.3);">🛠️ Accessories</h2>
        ...
        <div class="section" style="background: #1A1A1A; padding: 40px; border-radius: 15px; box-shadow: 0 6px 15px rgba(0, 0, 0, 0.4);">
            <div id="accessoryList" style="display: flex; flex-wrap: wrap; gap: 20px; justify-content: center;">
